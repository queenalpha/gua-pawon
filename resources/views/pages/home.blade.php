...
@section('home')
    ...
    <div class="max-w-6xl mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-4 pb-10">
        <div class="md:col-span-2 overflow-hidden rounded shadow-lg group h-64 md:h-96 lg:h-120">
            <img src="{{ Vite::asset('resources/img/image 90.png') }}" alt="Gua Pawon"
                class="w-full h-full object-cover group-hover:scale-110 transition duration-300" />
        </div>
        <div class="overflow-hidden rounded shadow-lg group h-64 md:h-96 lg:h-120">
            <img src="{{ Vite::asset('resources/img/image 91.png') }}" alt="Gua Pawon"
                class="w-full h-full object-cover group-hover:scale-110 transition duration-300" />
        </div>
    </div>
    ...
    <div class="lg:py-8 max-w-6xl mx-auto px-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 my-10">
        <div class="overflow-hidden rounded shadow-lg">
            ...
            <a href="/history"
                class="bg-[#2A1B0F] text-white flex justify-between px-4 py-2 hover:bg-[#3a2919] transition">
                <span>{{__('components/navbar.sejarah')}}</span> <span>→</span>
            </a>
        </div>
        <div class="overflow-hidden rounded shadow-lg">
            <img src="{{ Vite::asset('resources/img/monyetekrpjg.jpg') }}" alt="Ekologi" class="w-full h-48 object-cover" />
        ...
        <div class="overflow-hidden rounded shadow-lg">
            <img src="{{ Vite::asset('resources/img/pawonlandscape.png') }}" alt="Konservasi"
                class="w-full h-48 object-cover" />
            <a href="/konservasi-penelitian"
                class="bg-[#2A1B0F] text-white flex justify-between px-4 py-2 hover:bg-[#3a2919] transition">
                <span>{{__('components/navbar.konservasi-penelitian')}}</span> <span>→</span>
            </a>
        </div>
        <div class="overflow-hidden rounded shadow-lg">
            <img src="{{ Vite::asset('resources/img/peneliti.jpg') }}" alt="Penelitian" class="w-full h-48 object-cover" />
            <a href="/journal" class="bg-[#2A1B0F] text-white flex justify-between px-4 py-2 hover:bg-[#3a2919] transition">
                <span>{{__('components/navbar.penelitian')}}</span> <span>→</span>
            </a>
        </div>
        <div class="overflow-hidden rounded shadow-lg">
            <img src="{{ Vite::asset('resources/img/artikel.jpg') }}" alt="Artikel" class="w-full h-48 object-cover" />
            <a href="/articles"
                class="bg-[#2A1B0F] text-white flex justify-between px-4 py-2 hover:bg-[#3a2919] transition">
        ...
        <div class="overflow-hidden rounded shadow-lg">
            <img src="{{ Vite::asset('resources/img/image 22.png') }}" alt="Kontak" class="w-full h-48 object-cover" />
            <a href="#kontak" class="bg-[#2A1B0F] text-white flex justify-between px-4 py-2 hover:bg-[#3a2919] transition">
    ...
    <div class="max-w-6xl mx-auto px-4 my-10">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center my-10">
            ...
            <div class="relative aspect-video w-full max-w-2xl">
                <iframe class="w-full h-full rounded" src="https://www.youtube.com/embed/DT0hJuvqKJA?si=_xw1hxCJAinvXFjj"
